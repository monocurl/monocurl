...
This index points to the split Monocurl authoring context resources. Read the
overview first, then load the focused resource that matches the current task.

- `monocurl://docs/ai-overview`: project overview, scene skeleton, slide/init rules, UI/timeline notes.
...
The full standard-library overview is separate at `monocurl://docs/stdlib`,
and raw stdlib wrapper sources are exposed under `monocurl://stdlib/*`.
